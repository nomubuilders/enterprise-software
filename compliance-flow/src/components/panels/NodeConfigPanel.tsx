...
function DockerContainerNodeConfig({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Image Selection */}
      <div>
        <h3 className="mb-3 text-sm font-medium text-white">Container Image</h3>
        <div className="space-y-3">
          <Input
            label="Image"
            value={image}
      ...
      {/* Command */}
      <div>
        <h3 className="mb-3 text-sm font-medium text-white">Command</h3>
        <Input
          label="Command"
          value={command}
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={addEnvVar} className="text-xs text-purple-400 hover:text-purple-300 flex items-center gap-1">
            <Plus size={12} /> Add
          </button>
        </div>
      ...
      {/* Resource Controls */}
      <div>
        <h3 className="mb-3 text-sm font-medium text-white">Resource Limits</h3>
        <div className="space-y-4">
          {/* CPU */}
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-sm text-slate-300">CPU Cores</label>
              <span className="text-sm font-medium text-white">{cpuLimit}</span>
            </div>
            <input
          ...
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-sm text-slate-300">Memory (MB)</label>
              <span className="text-sm font-medium text-white">{memoryLimit}MB</span>
            </div>
            <input
          ...
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-sm text-slate-300">Timeout (seconds)</label>
              <span className="text-sm font-medium text-white">{timeoutSecs}s</span>
            </div>
            <Input
      ...
      {/* Network Mode */}
      <div>
        <h3 className="mb-3 text-sm font-medium text-white">Network Mode</h3>
        <div className="grid grid-cols-2 gap-2">
          <button
          ...
          >
            <p className="font-medium text-white">Air-Gapped</p>
            <p className="text-xs text-slate-400">No network access</p>
          </button>
          <button
          ...
          >
            <p className="font-medium text-white">Internal Only</p>
            <p className="text-xs text-slate-400">Docker network only</p>
          </button>
        </div>
      </div>
